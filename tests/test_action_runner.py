...
class ActionRunnerTests(unittest.TestCase):
    ...
    def test_provision_mission_control_secrets_is_bounded_and_redacted(self):
        ...
        self.assertIn("bcryptjs", rendered)
        self.assertIn("ntfy_admin_password_hash", rendered)
        self.assertIn("ntfy_service_password_hash", rendered)
        self.assertNotIn("ntfy_service_password=/", rendered)
        self.assertNotIn(".service-password.", rendered)
        self.assertIn("process.stdout.write(hash+", rendered)
        self.assertIn("\\n", rendered)
    ...
    def test_deploy_mission_control_stack_is_bounded_and_recoverable(self):
        ...
        self.assertIn("--cap-add CHOWN", rendered)
